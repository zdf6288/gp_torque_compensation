...
class CartesianModelFreeController(Node):
    
    def __init__(self):
        super().__init__('cartesian_model_free')
    ...
    def save_data_to_file(self):
        ...
        try:
            import csv
            filename = 'cartesian_controller_data.csv'
...
def main(args=None):
    ...
    cartesian_model_free_node = CartesianModelFreeController()
    try:
