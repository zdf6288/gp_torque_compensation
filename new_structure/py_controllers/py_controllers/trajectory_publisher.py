...
class TrajectoryPublisher(Node):
    ...
    def __init__(self):
        ...
        # GOAL2-B complex tracking matrix 使用的 spatial multisine position trajectory。
        # 名称沿用已验证的 goal1_spatial_multisine，但它不是 GOAL1 historical，
        # 只改变 /task_space_command，不影响 torque safety gating。
