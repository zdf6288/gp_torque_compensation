...
controller_interface::InterfaceConfiguration ElbowExampleController::command_interface_configuration() const {
...
controller_interface::InterfaceConfiguration ElbowExampleController::state_interface_configuration() const {
    return controller_interface::InterfaceConfiguration{controller_interface::interface_configuration_type::NONE};
}

controller_interface::return_type ElbowExampleController::update(const rclcpp::Time& /*time*/, const rclcpp::Duration& /*period*/) {
    ...
    std::array<double, 2> elbow_command = {{initial_elbow_configuration_[0] + angle, initial_elbow_configuration_[1]}};
...
CallbackReturn ElbowExampleController::on_init() { return CallbackReturn::SUCCESS; }

CallbackReturn ElbowExampleController::on_configure(const rclcpp_lifecycle::State& /*previous_state*/) {
    initial_cartesian_velocity_and_elbow.reserve(8);

    franka_cartesian_velocity_ = std::make_unique<franka_semantic_components::FrankaCartesianVelocityInterface>(franka_semantic_components::FrankaCartesianVelocityInterface(k_elbow_activated_));
...
CallbackReturn ElbowExampleController::on_activate(const rclcpp_lifecycle::State& /*previous_state*/) {
...
controller_interface::CallbackReturn ElbowExampleController::on_deactivate(const rclcpp_lifecycle::State& /*previous_state*/) {
...
// NOLINTNEXTLINE
PLUGINLIB_EXPORT_CLASS(franka_example_controllers::ElbowExampleController, controller_interface::ControllerInterface)