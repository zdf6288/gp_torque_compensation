...
class Model {  // NOLINT(cppcoreguidelines-pro-type-member-init,
   ...
   public:
     ...
     */
    [[nodiscard]] std::array<double, 16> pose(franka::Frame frame, const std::array<double, 7>& q,  // NOLINT(readability-identifier-length)
     ...
     */
    [[nodiscard]] std::array<double, 42> bodyJacobian(franka::Frame frame, const std::array<double, 7>& q,  // NOLINT(readability-identifier-length)
                                                      const std::array<double, 16>& F_T_EE,                 // NOLINT(readability-identifier-naming)
                                                      const std::array<double, 16>& EE_T_K)                 // NOLINT(readability-identifier-naming)
        const {
     ...
     * @return Vectorized 6x7 Jacobian, column-major.
     */
    [[nodiscard]] std::array<double, 42> zeroJacobian(franka::Frame frame, const std::array<double, 7>& q,  // NOLINT(readability-identifier-length)
                                                      const std::array<double, 16>& F_T_EE,                 // NOLINT(readability-identifier-naming)
                                                      const std::array<double, 16>& EE_T_K)                 // NOLINT(readability-identifier-naming)
        const {
     ...
     */
    [[nodiscard]] std::array<double, 49> mass(const std::array<double, 7>& q,                           // NOLINT(readability-identifier-length)
                                              const std::array<double, 9>& I_total,                     // NOLINT(readability-identifier-naming)
                                              double m_total, const std::array<double, 3>& F_x_Ctotal)  // NOLINT(readability-identifier-naming)
        const noexcept {
     ...
     */
    [[nodiscard]] std::array<double, 7> coriolis(const std::array<double, 7>& q,                           // NOLINT(readability-identifier-length)
     ...
     */
    [[nodiscard]] std::array<double, 7> gravity(const std::array<double, 7>& q,                           // NOLINT(readability-identifier-length)
                                                double m_total, const std::array<double, 3>& F_x_Ctotal,  // NOLINT(readability-identifier-naming)
     ...
     * @return Vectorized 4x4 pose matrix, column-major.
     */
    [[nodiscard]] virtual std::array<double, 16> pose(franka::Frame frame, const franka::RobotState& robot_state) const { return pose(frame, robot_state.q, robot_state.F_T_EE, robot_state.EE_T_K); }
     ...
     * @return Vectorized 6x7 Jacobian, column-major.
     */
    [[nodiscard]] virtual std::array<double, 42> bodyJacobian(franka::Frame frame, const franka::RobotState& robot_state) const {
     ...
     * @return Vectorized 6x7 Jacobian, column-major.
     */
    [[nodiscard]] virtual std::array<double, 42> zeroJacobian(franka::Frame frame, const franka::RobotState& robot_state) const {
     ...
     * @return Vectorized 7x7 mass matrix, column-major.
     */
    [[nodiscard]] virtual std::array<double, 49> mass(const franka::RobotState& robot_state) const { return mass(robot_state.q, robot_state.I_total, robot_state.m_total, robot_state.F_x_Ctotal); }
     ...
     * @return Coriolis force vector.
     */
    [[nodiscard]] virtual std::array<double, 7> coriolis(const franka::RobotState& robot_state) const {
     ...
     * @return Gravity vector.
     */
    [[nodiscard]] virtual std::array<double, 7> gravity(const franka::RobotState& robot_state, const std::array<double, 3>& gravity_earth) const {
