...
#include "custom_msgs/msg/detail/custom_var__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/float64_multi_array__functions.h"  // ddq_computed, dq_des, dq_meas, error_endo, error_rcm, q_des, q_meas
...
using _CustomVar__ros_msg_type = custom_msgs__msg__CustomVar;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CustomVar__ros_msg_type * ros_message = static_cast<const _CustomVar__ros_msg_type *>(untyped_ros_message);
  // Field name: q_des
  {
  ...
  // Field name: dq_meas
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->dq_meas, cdr))
    {
      return false;
    }
  }

  // Field name: ddq_computed
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->ddq_computed, cdr))
    {
      return false;
    }
  }

  // Field name: error_endo
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->error_endo, cdr))
    {
      return false;
    }
  }

  // Field name: error_rcm
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  void * untyped_ros_message)
{
  ...
  _CustomVar__ros_msg_type * ros_message = static_cast<_CustomVar__ros_msg_type *>(untyped_ros_message);
  // Field name: q_des
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_custom_msgs__msg__CustomVar(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CustomVar__ros_msg_type * ros_message = static_cast<const _CustomVar__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CustomVar__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__CustomVar(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__CustomVar(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__CustomVar;
    is_plain =
      (
...
static size_t _CustomVar__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__CustomVar(
...
static message_type_support_callbacks_t __callbacks_CustomVar = {
  "custom_msgs::msg",
  "CustomVar",
...
static rosidl_message_type_support_t _CustomVar__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CustomVar,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, CustomVar)() {
  return &_CustomVar__type_support;
}
